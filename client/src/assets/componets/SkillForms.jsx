...
const SkillForms = ({data,onChange}) => {
  ...
  return (
    ...
    //         <input type='text' placeholder='Enter a skill (e.g., Javascript,Project Management)' className='felx-1 px-3 py-2 text-sm' 
...
<div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Add your tecnical and soft skills
        </p>
      </div>
