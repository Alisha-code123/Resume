...
const PersonalInform = ({data,onChange,removeBackground,setRemoveBackground}) => {
    ...
    const fields=[
      ...
      {key:"website",lable:"Personal Website",icon:Globe,type:"url"},
    ]
