...
const Colorpicor = ({selectedColor,onChange}) => {
    const colors=[
...
{name: "Amber", value: "#F59E0B"},
  ...
  return (
    ...
    <button onClick={()=>setIsopen(!isOpen)} className='flex items-center gap-1 text-sm text-shadow-purple-600 bg-gradient-to-br from-purple-50 to-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
