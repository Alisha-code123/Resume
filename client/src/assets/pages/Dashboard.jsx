...
import {FilePenLineIcon, PencilIcon, PlusIcon, TrashIcon, Upload, UploadCloud, UploadCloudIcon, XIcon} from "lucide-react"
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent '> Welcome, Alisha Kumari</p>
        ...
        return(
          <button key={index} className='relative w-full sm:max-w-36 h-48 flex flex-col items-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer' style={{background: `linear-CanvasGradient(135debugger,${basecolor}10,${basecolor}40)`,borderColor:basecolor + "40"}}>
